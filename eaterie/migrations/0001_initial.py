# Generated by Django 2.2.11 on 2020-04-29 19:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preference_1', models.CharField(choices=[('ITA', 'Italian'), ('FF', 'Fast Food'), ('CHN', 'Chinese'), ('VTN', 'Vietnamese'), ('MEX', 'Mexican')], default='ITA', max_length=64)),
                ('preference_2', models.CharField(choices=[('ITA', 'Italian'), ('FF', 'Fast Food'), ('CHN', 'Chinese'), ('VTN', 'Vietnamese'), ('MEX', 'Mexican')], default='VTN', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='eaterie.Order')),
            ],
        ),
        migrations.CreateModel(
            name='Restaurant',
