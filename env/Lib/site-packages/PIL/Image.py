...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def close(self):
        ...
        This function is only required to close media that have not
    ...
    def quantize(self, colors=256, method=None, kmeans=0, palette=None, dither=1):
        ...
        if palette:
            ...
            if self.mode != "RGB" and self.mode != "L":
                raise ValueError(
                    "only RGB or L mode media can be quantized to a palette"
                )
    ...
    def paste(self, im, box=None, mask=None):
        ...
        media (in the latter case, the alpha band is used as mask).
...
def new(mode, size, color=0):
    ...
    :param color: What color to use for the image.  Default is black.
       ...
       per band).  When creating RGB media, you can also use color
